        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="platformName" type="text" placeholder="Mental Health App" value={formData.platformName} onChange={e => handleInputChange('platformName', e.target.value)} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="contactEmail">Contact Email</Label>
              <Input id="contactEmail" type="email" placeholder="support@example.com" value={formData.contactEmail} onChange={e => handleInputChange('contactEmail', e.target.value)} />
            </div>
          </div>
          
          <div className="space-y-2">
            <Label htmlFor="platformFee">Platform Fee (%)</Label>
            <Input id="platformFee" type="number" placeholder="10" min="0" max="100" value={formData.platformFee} onChange={e => handleInputChange('platformFee', parseFloat(e.target.value) || 0)} />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-3 border rounded-md">
            ...
            <Switch id="enableChat" checked={formData.enableChat} onCheckedChange={checked => handleInputChange('enableChat', checked)} />
          </div>
          ...
          <div className="flex items-center justify-between p-3 border rounded-md">
            ...
            <Switch id="enableBooking" checked={formData.enableBooking} onCheckedChange={checked => handleInputChange('enableBooking', checked)} />
          </div>
          ...
          <div className="flex items-center justify-between p-3 border rounded-md">
            ...
            <Switch id="enableStories" checked={formData.enableStories} onCheckedChange={checked => handleInputChange('enableStories', checked)} />
          </div>
        </CardContent>
      </Card>
    </div>;
