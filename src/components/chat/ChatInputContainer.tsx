...
export default function ChatInputContainer({
  ...
  // Desktop: fixed at bottom of container, no sticky needed
  return (
    <div className="shrink-0 border-t border-gray-200 dark:border-[#2a2a2a] bg-white dark:bg-[#1a1a1a] shadow-lg">
      <ChatInput onSendMessage={onSendMessage} />
    </div>
  );
}
