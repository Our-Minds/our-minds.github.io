...
export function ChatSidebar({ selectedChatId, onSelectChat }: ChatSidebarProps) {
  ...
  return (
    ...
    `}>
      ...
      {/* Conversations List */}
      <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent hover:scrollbar-thumb-gray-400 dark:hover:scrollbar-thumb-gray-500 min-h-0">
        {isLoading ? (
