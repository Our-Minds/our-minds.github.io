  ...
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      ...
      orientation === "vertical" &&
        "h-full w-1.5 border-l border-l-transparent p-[1px] opacity-0 hover:opacity-100",
      orientation === "horizontal" &&
        "h-1.5 flex-col border-t border-t-transparent p-[1px] opacity-0 hover:opacity-100",
      className
    )}
    {...props}
  >
