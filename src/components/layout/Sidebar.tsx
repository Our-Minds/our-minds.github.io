...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <aside className={cn("w-12 md:w-48 h-full overflow-x-hidden bg-gray-200 dark:bg-[#1a1a1a] border-r border-gray-300 dark:border-[#2a2a2a] flex-shrink-0", className)}>
      <nav className="flex-1 min-h-0 flex flex-col py-4 overflow-x-hidden">
