...
export function FeaturedStory({
  ...
  if (isLoading) {
    return <div className="relative overflow-hidden rounded-3xl shadow-2xl h-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#161b22] dark:to-[#21262d]">
  ...
  if (!featuredStory) {
    return <div className="rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#161b22] dark:to-[#21262d] h-full flex items-center justify-center">
  ...
  return <Link to={`/story/${featuredStory.id}`} className="block h-full">
      <div className="relative overflow-hidden rounded-3xl shadow-2xl h-full bg-white dark:bg-[#161b22]">
        {/* Decorative elements */}
        ...
        <div className="relative h-3/5 overflow-hidden">
          <img src={featuredStory.cover_image} alt={featuredStory.title} className="w-full h-full object-cover" onError={e => {
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                  <span>Author</span>
                  <span>•</span>
                  <span>{formatDistanceToNow(new Date(featuredStory.published_at), {
                    addSuffix: true
                  })}</span>
                </div>
              </div>
